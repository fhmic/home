...
PAGES["cookies"] = ("Cookie Policy", "".join([
    ...
    sec("2. Categories",
        ["<b>Strictly necessary:</b> session and login tokens required to keep you signed in. These cannot be disabled without losing the ability to log in.",
         "<b>Preference:</b> remembers your light or dark theme choice and similar display settings.",
...
PAGES["ai-consent"] = ("AI Consent &amp; Disclosure", "".join([
    ...
    sec("2. What is sent",
        "Only the minimum data needed to generate the specific output you request is sent to the AI provider (Anthropic), for example portfolio composition for a rebalancing suggestion, or your topic and angle inputs for content generation. We do not knowingly send full account credentials or unrelated personal data."),
    sec("3. Your consent",
    ...
    sec("4. Limitations",
        "AI-generated output can be wrong, biased, or out of date. Treat it as a starting point, not a final answer (see the <a href=\"../disclaimer/\">Disclaimer</a>), and review it yourself before acting on it or sharing it externally, for example in a board report."),
...
PAGES["data-processing-notice"] = ("Data Processing Notice", "".join([
    ...
    sec("Controller",
        "FM Finance Suite (operated by Felix Happy Michael) is the data controller for account-level and platform-usage data. Where you use a Corporate account, your employer or organisation may also act as a controller for the financial data it inputs. See the <a href=\"../dpa/\">DPA</a> for detail."),
    ...
    sec("Recipients",
        "Hosting and infrastructure providers, and, only for AI-labelled features, our AI provider. See <a href=\"../ai-consent/\">AI Consent</a> for detail."),
    sec("Retention",
        "For as long as your account is active, plus a limited period for legal and audit purposes. See <a href=\"../privacy/\">Privacy Policy</a> section 7."),
    sec("Your rights",
...
PAGES["consent-release"] = ("Consent &amp; Release", "".join([
    sec("By creating an account or using the Services, you acknowledge and agree that:",
        ["You have read and accept the <a href=\"../terms/\">Terms of Service</a>, <a href=\"../privacy/\">Privacy Policy</a>, and <a href=\"../acceptable-use/\">Acceptable Use Policy</a>.",
         "You understand outputs of the Services (dashboards, calculations, AI suggestions, and generated reports) are decision-support tools, not professional advice. See the <a href=\"../disclaimer/\">Disclaimer</a> for detail.",
